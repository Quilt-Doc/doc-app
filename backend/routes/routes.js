...
router.post('/documents/delete', document_controller.deleteDocument);
router.post('/documents/rename', document_controller.renameDocument);
router.post('/documents/move', document_controller.moveDocument);
