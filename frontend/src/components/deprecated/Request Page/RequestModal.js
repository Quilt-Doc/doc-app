...
class PullRequestDetail extends Component {
    constructor(props){
        super(props)
        this.state = {
            title: "",
...
export default  connect(mapStateToProps, { getRequest, editRequest, deleteRequest, setRequestCreation, attachTag, removeTag })(PullRequestDetail);
