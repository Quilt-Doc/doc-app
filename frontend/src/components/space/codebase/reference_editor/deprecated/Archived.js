...
class ReferenceEditor extends React.Component {
    ...
    renderSnippets() {
        ...
        while (i < lines.length) {
            if (this.props.snippets 
                ...
                const snippet =   <Snippet 
                                    ...
                                    ref={snippetRef} 
                                    index = {i}
                                    ReferenceEditorState = {this.state}
        ...
        const allCode = <CodeText 
                            ...
                            className = {`codetext${this.state.selectionMode || this.state.reselectingSnippet !== null 
                                ? " marker-mode" : ""}`}>
...
export default withRouter(connect(mapStateToProps, {retrieveSnippets, createSnippet, editSnippet, 
    ...
    retrieveCodeReferences, retrieveReferences, getRepository, attachTag, removeTag, getReferenceFromPath})(ReferenceEditor));
