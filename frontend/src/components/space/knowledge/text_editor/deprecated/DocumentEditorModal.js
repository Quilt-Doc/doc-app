...
import DocumentInfo from '../editor/DocumentInfo';
			...
			<Slate editor={editor} value={value} onChange={value => setValue(value)}>
				...
				<Container>
					...
					<EditorContainer>
							<div>
								<KeyToolbar >
										<KeyBorder3 to = {props.link} >
											<CgArrowsExpandLeft/>
										</KeyBorder3>
										<KeyBorder margin = {true} active = {write} onClick = {() => {setWrite(!write)}}>
											<RiPencilLine/>
										</KeyBorder>
							...
							<EditorContainer3>
								...
								<EditorContainer2 >
									...
									<AuthorNote paddingLeft = {write ? "3rem" : "10rem"}>Karan Godara, Apr 25, 2016</AuthorNote>
									<StyledEditable
										onClick={() => {
...
const EditorContainer3 = styled.div`
	display: flex;
	max-width: 94rem;
	width: 85vw;
`
