...
class RepositoryMenu3 extends React.Component {
    ...
    selectRepository(repo){
        const { selectRepository } = this.props;
        this.closeMenu()
    }
    ...
    render() {
        ...
        return(
            <MenuContainer >
                 <MenuButton borderColor = {borderColor}  active = {open} onClick = {(e) => this.openMenu(e)}>
                        <IconBorder>    
                            <VscRepo/>
                        </IconBorder>
                        <LimitedTitle>{fullName}</LimitedTitle>
                        <FiChevronDown 
                                style = {{
                                    marginLeft: "0.5rem",
                                    marginTop: "0.3rem",
...
export default withRouter(connect( mapStateToProps, {editDocument} )(RepositoryMenu3));
