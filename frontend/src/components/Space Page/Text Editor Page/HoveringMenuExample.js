		...
		<MenuHeader>Insert Blocks</MenuHeader>
			{
				filteredBlockTypes.map(block => {
					return (
						<MenuButton onClick={() => { toggleBlock(editor, props, block.block) }}>
